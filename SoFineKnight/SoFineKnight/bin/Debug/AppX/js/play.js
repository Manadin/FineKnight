...
var playState = {
    ...
    create: function() {
        ...
        for (var i = 0; i < 8; i++) {
            ground = platforms.create(game.world.width - 150 + (i * 16), game.world.height - 200, 'stoneTile');
            ground.scale.setTo(1, 1);
            ground.body.immovable = true;

            ground = platforms.create(game.world.width - 300 + (i * 16), game.world.height - 250, 'stoneTile');
            ground.scale.setTo(1, 1);
            ground.body.immovable = true;
        }
